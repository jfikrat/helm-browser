  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        steps: {
          ...
          items: {
            ...
            properties: {
                type: {
                  type: "string",
                  enum: ["click", "type", "submit", "pressKey", "select", "wait", "getUrl", "getElementText", "query", "assertText", "assertUrl", "assertExists", "assertCount"],
                },
              ...
              match: { type: "string", enum: ["first", "best", "all", "includes", "equals", "startsWith"], description: "Match mode for query and assertUrl steps" },
              ...
              message: { type: "string", description: "Optional custom error message for assertion steps" },
              min: { type: "number", description: "Minimum count for assertCount steps" },
              max: { type: "number", description: "Maximum count for assertCount steps" },
              ...
              value: { type: "string", description: "Option value for select steps or expected URL value for assertUrl steps" },
        ...
        captureSnapshot: {
          oneOf: [
            { type: "boolean", description: "If true, attach a snapshot delta after the last step" },
            {
              type: "array",
              items: { type: "number" },
              description: "Attach snapshot deltas after the specified zero-based step indices",
            },
          ],
        },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit: { type: "number", description: "Optional maximum number of elements to return" },
        viewportOnly: { type: "boolean", description: "Only include elements that are currently in the viewport" },
        ranked: { type: "boolean", description: "Sort elements by relevance (viewport, controls, buttons, links)" },
        tabId: { type: "number", description: "Optional: specific tab" },
      },
    },
  },
